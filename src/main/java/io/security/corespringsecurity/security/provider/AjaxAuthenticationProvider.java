...
/**
 * Ajax 로그인 인증 검증 Customizing 클래스 <br/>
...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
     ...
     * 일치할 경우 AjaxAuthenticationToken 토큰 객체에 사용자 정보와, 권한정보를 담아 반환한다.
    ...
    public boolean supports(Class<?> authentication) {
        return AjaxAuthenticationToken.class
                .isAssignableFrom(authentication); //토큰이 클래스 타입과 일치할 때 AjaxAuthenticationProvider가 인증을 처리하도록
    }
}
